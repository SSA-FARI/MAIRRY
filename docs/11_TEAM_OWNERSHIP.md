...
| C — 계약·대화 | 추출값을 확정 계약으로 만들고 근거 기반 답변을 제공한다 | 검수, 계약 CRUD, 확정 트랜잭션, Chat Tool·응답 | REVIEW, CONTRACT, CHAT | B의 Document, A의 Finance Tool 사용 |
